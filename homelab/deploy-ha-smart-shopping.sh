...
pkg_path = os.path.join(os.environ["ROOT"], "homelab/ha-packages/nourish-smart-shopping.yaml")
with open(pkg_path) as f:
    guest_write("/mnt/data/supervisor/homeassistant/packages/nourish-smart-shopping.yaml", f.read())
